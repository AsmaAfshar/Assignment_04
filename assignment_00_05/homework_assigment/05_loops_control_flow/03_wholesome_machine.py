...
# Sometimes, especially in the midst of such uncertain times, we just need to be reminded that we
# are resilient, capable, and strong; this little Python program may be able to help!
#Here's a sample run of the program (user input is in blue):
#Please type the following affirmation: I am capable of doing anything I put my mind to.
# Hmmm That was not the affirmation. Please type the following affirmation: I am capable of
# doing anything I put my mind to. I am capable of doing anything I put my mind to. That's right! :)
