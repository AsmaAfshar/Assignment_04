...
# Age assignments based on the riddle and corrected Anton's age
Anton = 3
Beth = Anton + 6          # 3 + 6 = 9
Chen = Beth + 20          # 9 + 20 = 29
Drew = Chen + Anton       # 29 + 3 = 32
Ethan = Chen              # same as Chen = 29

# Printing the names and ages in the required format
print("Anton is 3 years old.")
print("Beth is 9 years old.")
print("Chen is 29 years old.")
print("Drew is 32 years old.")
print("Ethan is 29 years old.")